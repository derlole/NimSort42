...
# main_logic
POSITION_UNCORN: tuple[float, float, float] = TransformWorldRobot.robot_to_world(-0.165,-0.135, 0.07)
POSITION_CAT: tuple[float, float, float] = TransformWorldRobot.robot_to_world(-0.065, -0.135, 0.07)
