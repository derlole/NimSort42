...
class TestTrajectoryPlanner:
    def test_init_valid(self):
        planner = TrajectoryPlanner(max_velocity=1.0, max_acceleration=2.0, position_tolerance=1e-6, velocity_tolerance=1e-6)
    ...
    def test_init_invalid_velocity(self):
        with pytest.raises(ValueError):
            TrajectoryPlanner(max_velocity=0.0, max_acceleration=1.0, position_tolerance=1e-6, velocity_tolerance=1e-6)

    def test_init_invalid_acceleration(self):
        with pytest.raises(ValueError):
            TrajectoryPlanner(max_velocity=1.0, max_acceleration=-1.0, position_tolerance=1e-6, velocity_tolerance=1e-6)

    def test_compute_accelerate(self):
        planner = TrajectoryPlanner(max_velocity=1.0, max_acceleration=1.0, position_tolerance=1e-6, velocity_tolerance=1e-6)
    ...
    def test_reached(self):
        # Use looser tolerances so small distances/velocities count as reached
        planner = TrajectoryPlanner(max_velocity=1.0, max_acceleration=1.0, position_tolerance=1e-4, velocity_tolerance=1e-3)
