...
\begin{document}
	...
	\begin{frame}{Meilensteine}
		\begin{itemize}
			\item Notwendige Koordinatensysteme festgelegt 
			\item Grundlagen realisieren. 
			\item Prädizierte Positionen im Weltkoordiantensystem Ausgeben 
			\item Regelung auf einen Punkt im Weltkoordinatensystem 
			\item Prozesslogik ist in Python Programmiert und getestet 
			\item Abschlusspräsentationen 
		\end{itemize}
	\end{frame}
	...
	\begin{frame}{Architektur-Achsen}
		\begin{center}
			\includegraphics[width=0.8\textwidth]{../pictures/arch1.png}
		\end{center}
	\end{frame}

	\begin{frame}{Architektur-Prozesslogik}
		\begin{center}
			\includegraphics[width=0.85\textwidth]{../pictures/arch2.png}
		\end{center}
	\end{frame}	
	
	\begin{frame}{Architektur-Kamera}
		\begin{center}
			\includegraphics[width=0.7\textwidth]{../pictures/arch3.png}
		\end{center}
	\end{frame}	
	...
	\begin{frame}
		\begin{columns}
			\begin{column}{0.6\textwidth}
				\includegraphics[width=0.78\textwidth]{../pictures/logo_nimsort42.png}
			\end{column}
			\begin{column}{0.4\textwidth}
				So leicht haben sie noch nie sortiert! Wie aus Zauberhand.\\
				
				Projektteam: \\
				Projektende: HIER DATUM
